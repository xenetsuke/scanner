...
# Replace these values with your actual Firebase project credentials and Web API Key
...
# Replace with your Web API Key and Firebase Realtime Database host
...
def scan_qr_code_and_send_to_firebase():
    ...
    while True:
        ...
        for obj in decoded_objects:
            ...
            new_data_ref = ref.push({'data': qr_data})
            print(f"Data sent to Firebase with data ID: {new_data_ref.key}")
